Return-Path: <usb-storage+bncBDMYPB44VAFRBT4DXLVQKGQEWWNXXRI@lists.one-eyed-alien.net>
X-Original-To: lists+usb-storage@lfdr.de
Delivered-To: lists+usb-storage@lfdr.de
Received: from mail-yw1-xc46.google.com (mail-yw1-xc46.google.com [IPv6:2607:f8b0:4864:20::c46])
	by mail.lfdr.de (Postfix) with ESMTPS id 0C75DA6C4E
	for <lists+usb-storage@lfdr.de>; Tue,  3 Sep 2019 17:08:01 +0200 (CEST)
Received: by mail-yw1-xc46.google.com with SMTP id a144sf10373303ywe.17
        for <lists+usb-storage@lfdr.de>; Tue, 03 Sep 2019 08:08:00 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1567523280; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         ...
         :date:dkim-signature;
        bh=8YKTi55MhXHjrLIh7H//x//CKYYYhllDN1tvsuHiIto=;
        b=
ARC-Authentication-Results: i=2; mx.google.com;
       dkim=pass header.i=@google.com header.s=20161025 header.b=dUY3N9dI;
       spf=pass (google.com: domain of 3zofuxqgkah0nbfoojdihpphmf.dpn@flex--maennich.bounces.google.com designates 209.85.220.73 as permitted sender) smtp.mailfrom=3zoFuXQgKAH0nbfoojdihpphmf.dpn@flex--maennich.bounces.google.com;
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        h=date:in-reply-to:message-id:mime-version:references:subject:from:to
         ...
         :list-unsubscribe;
        bh=8YKTi55MhXHjrLIh7H//x//CKYYYhllDN1tvsuHiIto=;
        b=grhZonQ6S/3HOQjoebGQWBmhkvuqTP1Pb76RYESrVUnvnhKfJlDfijBCdvxeWK+2Z2
         UEXFIOGS47lxtycM15RFeHGkV6n3o0MVA5rh2/ksabOYRN5R7jFdzokPwy8CJMKV/cbe
         zK1rOs6yKgAL/I+wncSxME+ij6I9JgE5/CXlQ=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=8YKTi55MhXHjrLIh7H//x//CKYYYhllDN1tvsuHiIto=;
        b=
X-Gm-Message-State: APjAAAUF+m+Xr3rfViPoQK6SOvPyy83SAR58V4ZivGo6jRBfNy41F7k/
	qhEIBUrPe4RRi9IOP8JcpIv3QA==
X-Google-Smtp-Source: APXvYqxLNSl3NmOriCvR/e/WSr37ebLmcf/Vha9j8LU0+BMLFf2GM0slUZRoaOy74Um028JtYQU3sw==
X-Received: by 2002:a0d:dbc4:: with SMTP id d187mr9575629ywe.158.1567523279838;
        Tue, 03 Sep 2019 08:07:59 -0700 (PDT)
X-BeenThere: usb-storage@lists.one-eyed-alien.net
Received: by 2002:a25:b94:: with SMTP id 142ls2400324ybl.5.gmail; Tue, 03 Sep
 2019 08:07:59 -0700 (PDT)
X-Received: by 2002:a25:bb0e:: with SMTP id z14mr24718349ybg.507.1567523279433;
        Tue, 03 Sep 2019 08:07:59 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1567523279; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=content-transfer-encoding:cc:to:from:subject:references
         :mime-version:message-id:in-reply-to:date:dkim-signature;
        bh=uiVNUyTgfDxnaV9scOzT4vW0KvshsQB635VtUxZQBM0=;
        b=
...
Received: from mail-sor-f73.google.com (mail-sor-f73.google.com. [209.85.220.73])
        by mx.google.com with SMTPS id b123sor5551639ywh.134.2019.09.03.08.07.59
        for <usb-storage@lists.one-eyed-alien.net>
        (Google Transport Security);
        Tue, 03 Sep 2019 08:07:59 -0700 (PDT)
Received-SPF: pass (google.com: domain of 3zofuxqgkah0nbfoojdihpphmf.dpn@flex--maennich.bounces.google.com designates 209.85.220.73 as permitted sender) client-ip=209.85.220.73;
...
Subject: [usb-storage] [PATCH v4 12/12] RFC: watchdog: export core symbols in
...
X-Original-Authentication-Results: mx.google.com;       dkim=pass
 header.i=@google.com header.s=20161025 header.b=dUY3N9dI;       spf=pass
 (google.com: domain of 3zofuxqgkah0nbfoojdihpphmf.dpn@flex--maennich.bounces.google.com
 designates 209.85.220.73 as permitted sender) smtp.mailfrom=3zoFuXQgKAH0nbfoojdihpphmf.dpn@flex--maennich.bounces.google.com;
       dmarc=pass (p=REJECT sp=REJECT dis=NONE) header.from=google.com
...
one-eyed-alien.net/d/msgid/usb-storage/20190903150638.242049-13-maennich%40=
google.com.
