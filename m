Return-Path: <usb-storage+bncBDY3NC743AGBBYHDUHZQKGQEQL4WXRA@lists.one-eyed-alien.net>
X-Original-To: lists+usb-storage@lfdr.de
Delivered-To: lists+usb-storage@lfdr.de
Received: from mail-qt1-x846.google.com (mail-qt1-x846.google.com [IPv6:2607:f8b0:4864:20::846])
	by mail.lfdr.de (Postfix) with ESMTPS id 70640180F1C
	for <lists+usb-storage@lfdr.de>; Wed, 11 Mar 2020 06:06:42 +0100 (CET)
Received: by mail-qt1-x846.google.com with SMTP id g6sf441593qtp.20
        for <lists+usb-storage@lfdr.de>; Tue, 10 Mar 2020 22:06:42 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1583903201; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         :list-id:mailing-list:precedence:mime-version:message-id:date
         :subject:cc:to:from:sender:dkim-signature;
        bh=XaETrCTaJkfzK91v3Qd/OIyRiXq94FgwzhfFad7Qz0w=;
        b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=XaETrCTaJkfzK91v3Qd/OIyRiXq94FgwzhfFad7Qz0w=;
        b=PzDRW7HUAJRSirZrUyjQaj95O/ocywSWznG5Yuo+NbtRr8PLcKAlBqMXQGqLjhYqmd
         s0EMluN7cuyjlGtL/FQNdGwXPfjALO+zrZbNrb0/EJGChXsuex1sl85aNyYQfsry8h1G
         YrEmfoOScaoU3wCWRXqgg5eBv/QKXGsbxkx5U=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=XaETrCTaJkfzK91v3Qd/OIyRiXq94FgwzhfFad7Qz0w=;
        b=
Sender: usb-storage@lists.one-eyed-alien.net
X-Gm-Message-State: ANhLgQ2IW9kqPfQYcAwiYR9bSD+wCfqI6swT/2uO9HbLC0576Knni65J
	f2kzpbqs/c2sLe+mZWwi7TLNrA==
X-Google-Smtp-Source: ADFU+vvvoizMM1/7yXlVbvtjowqlfpRy0lR91PaV+qPonT5dwRuk3Pn46RwjAs3s4pd2PbOQXLEyNw==
X-Received: by 2002:a37:4c82:: with SMTP id z124mr1147394qka.47.1583903200970;
        Tue, 10 Mar 2020 22:06:40 -0700 (PDT)
X-BeenThere: usb-storage@lists.one-eyed-alien.net
Received: by 2002:a37:6542:: with SMTP id z63ls490413qkb.3.gmail; Tue, 10 Mar
 2020 22:06:40 -0700 (PDT)
X-Received: by 2002:a37:a8d8:: with SMTP id r207mr1103821qke.123.1583903200135;
        Tue, 10 Mar 2020 22:06:40 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1583903200; cv=none;
        d=google.com; s=arc-20160816;
        b=
...
Received: from smtprelay.hostedemail.com (smtprelay0106.hostedemail.com. [216.40.44.106])
        by mx.google.com with ESMTPS id a85si374076qkb.249.2020.03.10.22.06.39
...
Subject: [usb-storage] [PATCH -next 000/491] treewide: use fallthrough;
...
To view this discussion on the web visit https://groups.google.com/a/lists.one-eyed-alien.net/d/msgid/usb-storage/cover.1583896344.git.joe%40perches.com.
