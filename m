Return-Path: <usb-storage+bncBC7M5BFO7YCRBCNBXLVQKGQEQBYQZCA@lists.one-eyed-alien.net>
X-Original-To: lists+usb-storage@lfdr.de
Delivered-To: lists+usb-storage@lfdr.de
Received: from mail-pl1-f200.google.com (mail-pl1-f200.google.com [209.85.214.200])
	by mail.lfdr.de (Postfix) with ESMTPS id 1EF57A6DA4
	for <lists+usb-storage@lfdr.de>; Tue,  3 Sep 2019 18:10:51 +0200 (CEST)
Received: by mail-pl1-f200.google.com with SMTP id f5sf10061194plr.0
        for <lists+usb-storage@lfdr.de>; Tue, 03 Sep 2019 09:10:51 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1567527049; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        ...
        bh=N1od7bs/y3z6XvXeYmKkRBzsGVPpD79pFsG8apTiiw8=;
        b=
ARC-Authentication-Results: i=2; mx.google.com;
       dkim=pass header.i=@gmail.com header.s=20161025 header.b=l3BfmDGW;
...
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=N1od7bs/y3z6XvXeYmKkRBzsGVPpD79pFsG8apTiiw8=;
        b=
X-Gm-Message-State: APjAAAWDN1C3cRuqnY8HpAHPkBE1gV/G8e8etYW0Jjn+8OF4d6+vewZC
	SzcZLaVz72fOgCuvacNIKebGRg==
X-Google-Smtp-Source: APXvYqzACPD0CnPWdzMm9RFF8r0FNg67o3UZsBrh4PEv1dElORt6kqXWDm3R/v8/f8rhH9ClevvH/A==
X-Received: by 2002:aa7:8436:: with SMTP id q22mr13478622pfn.74.1567527049587;
        Tue, 03 Sep 2019 09:10:49 -0700 (PDT)
X-BeenThere: usb-storage@lists.one-eyed-alien.net
Received: by 2002:aa7:83cb:: with SMTP id j11ls4108797pfn.5.gmail; Tue, 03 Sep
 2019 09:10:48 -0700 (PDT)
X-Received: by 2002:a65:62cd:: with SMTP id m13mr30808610pgv.437.1567527048575;
        Tue, 03 Sep 2019 09:10:48 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1567527048; cv=none;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=1; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=user-agent:in-reply-to:content-transfer-encoding
         :content-disposition:mime-version:references:message-id:subject:cc
         :to:from:date:sender:dkim-signature;
        bh=fefdS7cVyYLBkcc3jI+Rh6dIwHyTMfcYUoe1BDRlgQU=;
        b=
ARC-Authentication-Results: i=1; mx.google.com;
       dkim=pass header.i=@gmail.com header.s=20161025 header.b=l3BfmDGW;
       spf=pass (google.com: domain of groeck7@gmail.com designates 209.85.220.65 as permitted sender) smtp.mailfrom=groeck7@gmail.com
Received: from mail-sor-f65.google.com (mail-sor-f65.google.com. [209.85.220.65])
        by mx.google.com with SMTPS id e1sor22744671plt.2.2019.09.03.09.10.48
...
X-Received: by 2002:a17:902:b717:: with SMTP id d23mr1330549pls.202.1567527048021;
        Tue, 03 Sep 2019 09:10:48 -0700 (PDT)
Received: from localhost ([2600:1700:e321:62f0:329c:23ff:fee3:9d7c])
        by smtp.gmail.com with ESMTPSA id q4sm19289077pff.183.2019.09.03.09.10.46
        (version=TLS1_2 cipher=ECDHE-RSA-AES128-GCM-SHA256 bits=128/128);
        Tue, 03 Sep 2019 09:10:46 -0700 (PDT)
Sender: Guenter Roeck <groeck7@gmail.com>
Date: Tue, 3 Sep 2019 09:10:45 -0700
...
Message-ID: <20190903161045.GA22754@roeck-us.net>
...
In-Reply-To: <20190903150638.242049-13-maennich@google.com>
User-Agent: Mutt/1.5.24 (2015-08-30)
X-Original-Sender: linux@roeck-us.net
X-Original-Authentication-Results: mx.google.com;       dkim=pass
 header.i=@gmail.com header.s=20161025 header.b=l3BfmDGW;       spf=pass
...
> diff --git a/drivers/hwmon/sch56xx-common.c b/drivers/hwmon/sch56xx-commo=
n.c
...
> diff --git a/drivers/watchdog/asm9260_wdt.c b/drivers/watchdog/asm9260_wd=
t.c
...
>  MODULE_LICENSE("GPL");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/at91sam9_wdt.c b/drivers/watchdog/at91sam9_=
wdt.c
> index 292b5a1ca831..e7aa31fe4336 100644
> --- a/drivers/watchdog/at91sam9_wdt.c
> +++ b/drivers/watchdog/at91sam9_wdt.c
> @@ -416,3 +416,4 @@ module_platform_driver_probe(at91wdt_driver, at91wdt_=
probe);
>  MODULE_AUTHOR("Renaud CERRATO <r.cerrato@til-technologies.fr>");
>  MODULE_DESCRIPTION("Watchdog driver for Atmel AT91SAM9x processors");
>  MODULE_LICENSE("GPL");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/atlas7_wdt.c b/drivers/watchdog/atlas7_wdt.=
c
...
> diff --git a/drivers/watchdog/bcm2835_wdt.c b/drivers/watchdog/bcm2835_wd=
t.c
...
>  MODULE_LICENSE("GPL");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/bcm47xx_wdt.c b/drivers/watchdog/bcm47xx_wd=
t.c
...
> diff --git a/drivers/watchdog/bcm_kona_wdt.c b/drivers/watchdog/bcm_kona_=
wdt.c
...
>  MODULE_LICENSE("GPL v2");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/bd70528_wdt.c b/drivers/watchdog/bd70528_wd=
t.c
...
>  MODULE_LICENSE("GPL");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/cadence_wdt.c b/drivers/watchdog/cadence_wd=
t.c
...
>  MODULE_LICENSE("GPL");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/da9052_wdt.c b/drivers/watchdog/da9052_wdt.=
c
...
> diff --git a/drivers/watchdog/da9055_wdt.c b/drivers/watchdog/da9055_wdt.=
c
...
> diff --git a/drivers/watchdog/davinci_wdt.c b/drivers/watchdog/davinci_wd=
t.c
...
> diff --git a/drivers/watchdog/digicolor_wdt.c b/drivers/watchdog/digicolo=
r_wdt.c
...
>  MODULE_LICENSE("GPL");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/ebc-c384_wdt.c b/drivers/watchdog/ebc-c384_=
wdt.c
...
> diff --git a/drivers/watchdog/ep93xx_wdt.c b/drivers/watchdog/ep93xx_wdt.=
c
...
>  MODULE_LICENSE("GPL");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/ftwdt010_wdt.c b/drivers/watchdog/ftwdt010_=
wdt.c
...
> diff --git a/drivers/watchdog/imgpdc_wdt.c b/drivers/watchdog/imgpdc_wdt.=
c
...
> @@ -433,4 +433,5 @@ module_platform_driver_probe(imx2_wdt_driver, imx2_wd=
t_probe);
...
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
>  MODULE_ALIAS("platform:" DRIVER_NAME);
> diff --git a/drivers/watchdog/intel-mid_wdt.c b/drivers/watchdog/intel-mi=
d_wdt.c
...
>  MODULE_DESCRIPTION("Hardware Watchdog Device Driver for IT87xx EC-LPC I/=
O");
>  MODULE_LICENSE("GPL");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/kempld_wdt.c b/drivers/watchdog/kempld_wdt.=
c
...
>  MODULE_LICENSE("GPL");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/lpc18xx_wdt.c b/drivers/watchdog/lpc18xx_wd=
t.c
...
>  MODULE_LICENSE("GPL v2");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/max63xx_wdt.c b/drivers/watchdog/max63xx_wd=
t.c
...
>  MODULE_LICENSE("GPL v2");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/max77620_wdt.c b/drivers/watchdog/max77620_=
wdt.c
> index be6a53c30002..304817d379a7 100644
> --- a/drivers/watchdog/max77620_wdt.c
> +++ b/drivers/watchdog/max77620_wdt.c
> @@ -209,3 +209,4 @@ MODULE_PARM_DESC(nowayout, "Watchdog cannot be stoppe=
d once started "
> =20
...
> diff --git a/drivers/watchdog/mena21_wdt.c b/drivers/watchdog/mena21_wdt.=
c
...
> diff --git a/drivers/watchdog/menf21bmc_wdt.c b/drivers/watchdog/menf21bm=
c_wdt.c
...
> diff --git a/drivers/watchdog/menz69_wdt.c b/drivers/watchdog/menz69_wdt.=
c
...
> diff --git a/drivers/watchdog/meson_gxbb_wdt.c b/drivers/watchdog/meson_g=
xbb_wdt.c
...
> diff --git a/drivers/watchdog/moxart_wdt.c b/drivers/watchdog/moxart_wdt.=
c
> index 6340a1f5f471..02dbfe2accfa 100644
> --- a/drivers/watchdog/moxart_wdt.c
> +++ b/drivers/watchdog/moxart_wdt.c
> @@ -164,4 +164,5 @@ MODULE_PARM_DESC(heartbeat, "Watchdog heartbeat in se=
conds");
> =20
...
> @@ -247,6 +247,7 @@ MODULE_PARM_DESC(nowayout, "Watchdog cannot be stoppe=
d once started (default=3D"
>  			__MODULE_STRING(WATCHDOG_NOWAYOUT) ")");
> =20
>  MODULE_LICENSE("GPL");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
...
>  MODULE_VERSION(DRV_VERSION);
> diff --git a/drivers/watchdog/ni903x_wdt.c b/drivers/watchdog/ni903x_wdt.=
c
...
>  MODULE_LICENSE("GPL");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/nic7018_wdt.c b/drivers/watchdog/nic7018_wd=
t.c
...
>  MODULE_LICENSE("GPL v2");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/of_xilinx_wdt.c b/drivers/watchdog/of_xilin=
x_wdt.c
...
> diff --git a/drivers/watchdog/pm8916_wdt.c b/drivers/watchdog/pm8916_wdt.=
c
...
>  MODULE_LICENSE("GPL v2");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/rave-sp-wdt.c b/drivers/watchdog/rave-sp-wd=
t.c
...
> diff --git a/drivers/watchdog/renesas_wdt.c b/drivers/watchdog/renesas_wd=
t.c
...
>  MODULE_LICENSE("GPL");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/rn5t618_wdt.c b/drivers/watchdog/rn5t618_wd=
t.c
...
>  MODULE_AUTHOR("Ben Dooks <ben@simtec.co.uk>, Dimitry Andric <dimitry.and=
ric@tomtom.com>");
>  MODULE_DESCRIPTION("S3C2410 Watchdog Device Driver");
>  MODULE_LICENSE("GPL");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/sama5d4_wdt.c b/drivers/watchdog/sama5d4_wd=
t.c
...
>  MODULE_LICENSE("GPL v2");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/sirfsoc_wdt.c b/drivers/watchdog/sirfsoc_wd=
t.c
...
>  MODULE_LICENSE("GPL");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/sp5100_tco.c b/drivers/watchdog/sp5100_tco.=
c
...
>  MODULE_LICENSE("GPL v2");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/st_lpc_wdt.c b/drivers/watchdog/st_lpc_wdt.=
c
...
> diff --git a/drivers/watchdog/stpmic1_wdt.c b/drivers/watchdog/stpmic1_wd=
t.c
...
> @@ -289,6 +289,7 @@ MODULE_PARM_DESC(nowayout, "Watchdog cannot be stoppe=
d once started "
...
> diff --git a/drivers/watchdog/tangox_wdt.c b/drivers/watchdog/tangox_wdt.=
c
...
>  MODULE_LICENSE("GPL v2");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/tqmx86_wdt.c b/drivers/watchdog/tqmx86_wdt.=
c
...
>  MODULE_LICENSE("GPL");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> diff --git a/drivers/watchdog/ts4800_wdt.c b/drivers/watchdog/ts4800_wdt.=
c
...
> diff --git a/drivers/watchdog/ts72xx_wdt.c b/drivers/watchdog/ts72xx_wdt.=
c
...
> =20
> diff --git a/drivers/watchdog/uniphier_wdt.c b/drivers/watchdog/uniphier_=
wdt.c
...
> @@ -180,7 +180,7 @@ void watchdog_set_restart_priority(struct watchdog_de=
vice *wdd, int priority)
>  {
...
>  {
> @@ -279,7 +279,7 @@ int watchdog_register_device(struct watchdog_device *=
wdd)
> =20
>  	return ret;
>  }
...
>  {
> @@ -311,7 +311,7 @@ void watchdog_unregister_device(struct watchdog_devic=
e *wdd)
...
> =20
>  static void devm_watchdog_unregister_device(struct device *dev, void *re=
s)
>  {
...
> diff --git a/drivers/watchdog/wm831x_wdt.c b/drivers/watchdog/wm831x_wdt.=
c
...
> diff --git a/drivers/watchdog/wm8350_wdt.c b/drivers/watchdog/wm8350_wdt.=
c
...
>  MODULE_DESCRIPTION("Zodiac Aerospace RAVE Switch Watchdog Processor Driv=
er");
>  MODULE_LICENSE("GPL");
> +MODULE_IMPORT_NS(WATCHDOG_CORE);
> --=20
...
one-eyed-alien.net/d/msgid/usb-storage/20190903161045.GA22754%40roeck-us.ne=
t.
