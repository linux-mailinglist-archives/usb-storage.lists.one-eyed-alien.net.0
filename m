Return-Path: <usb-storage+bncBC27X66SWQMBBTNOVT6AKGQEFLLJMWI@lists.one-eyed-alien.net>
X-Original-To: lists+usb-storage@lfdr.de
Delivered-To: lists+usb-storage@lfdr.de
Received: from mail-ed1-x547.google.com (mail-ed1-x547.google.com [IPv6:2a00:1450:4864:20::547])
	by mail.lfdr.de (Postfix) with ESMTPS id 75A2D2912E3
	for <lists+usb-storage@lfdr.de>; Sat, 17 Oct 2020 18:09:50 +0200 (CEST)
Received: by mail-ed1-x547.google.com with SMTP id f19sf3121411edx.18
        for <lists+usb-storage@lfdr.de>; Sat, 17 Oct 2020 09:09:50 -0700 (PDT)
ARC-Seal: i=2; a=rsa-sha256; t=1602950990; cv=pass;
        d=google.com; s=arc-20160816;
        b=
ARC-Message-Signature: i=2; a=rsa-sha256; c=relaxed/relaxed; d=google.com; s=arc-20160816;
        h=list-unsubscribe:list-subscribe:list-archive:list-help:list-post
         :list-id:mailing-list:precedence:message-id:date:subject:cc:to:from
         :mime-version:sender:dkim-signature;
        bh=1LJyh+2L2i+daTC4u4WxHDZYi136dpW/5jsyH1uhwHs=;
        b=
...
DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=1LJyh+2L2i+daTC4u4WxHDZYi136dpW/5jsyH1uhwHs=;
        b=FDuw/otdNO/8HzWEFTtXVzNqeq9xtyYq1aPKhEphTAIVHuwoHO+q+gMcnOHqEaSr/G
         ewqAdk59mYGjZdCuNZYVBZPcbTC4IoCXuV8z4ZP2OE2CxJCeR93TqAnOHJ6SZAQjqZGi
         eSU4DXPhXZlV2rbrCx4Oog8Y3TApZEyAYIKmE=
X-Google-DKIM-Signature: v=1; a=rsa-sha256; c=relaxed/relaxed;
        ...
        bh=1LJyh+2L2i+daTC4u4WxHDZYi136dpW/5jsyH1uhwHs=;
        b=
Sender: usb-storage@lists.one-eyed-alien.net
X-Gm-Message-State: AOAM5310ogz4jbNlCjGJffBO7KAP0NKfrxBUUx49uHGfUr2SwtYWX42q
	Z/FQ3C5+MtIzGvyhkjcEIY/G1Q==
X-Google-Smtp-Source: ABdhPJxaIXa1EEojSUqvoKjquz5Kg4IECn+XxvobGx50z6G4CrQZQCmlIckU0iJbxQ8CctKwEAmQOw==
X-Received: by 2002:a17:906:4695:: with SMTP id a21mr9022288ejr.357.1602950989733;
        Sat, 17 Oct 2020 09:09:49 -0700 (PDT)
MIME-Version: 1.0
X-BeenThere: usb-storage@lists.one-eyed-alien.net
Received: by 2002:a17:907:7381:: with SMTP id er1ls2694275ejc.8.gmail; Sat, 17
 Oct 2020 09:09:48 -0700 (PDT)
X-Received: by 2002:a17:906:9394:: with SMTP id l20mr9295716ejx.40.1602950988115;
        Sat, 17 Oct 2020 09:09:48 -0700 (PDT)
ARC-Seal: i=1; a=rsa-sha256; t=1602950988; cv=none;
        d=google.com; s=arc-20160816;
        b=
...
Received: from us-smtp-delivery-124.mimecast.com (us-smtp-delivery-124.mimecast.com. [216.205.24.124])
        by mx.google.com with ESMTPS id v13si5694041edl.552.2020.10.17.09.09.47
...
Received: from mail-ot1-f70.google.com (mail-ot1-f70.google.com
 ...
 us-mta-375-HCEyiffoP3aXbKDRbPCIGg-1; Sat, 17 Oct 2020 12:09:40 -0400
X-MC-Unique: HCEyiffoP3aXbKDRbPCIGg-1
Received: by mail-ot1-f70.google.com with SMTP id x12so2541340otq.11
        for <usb-storage@lists.one-eyed-alien.net>; Sat, 17 Oct 2020 09:09:40 -0700 (PDT)
X-Received: by 2002:aca:cc01:: with SMTP id c1mr6215382oig.128.1602950978384;
...
Subject: [usb-storage] [RFC] treewide: cleanup unreachable breaks
...
To view this discussion on the web visit https://groups.google.com/a/lists.one-eyed-alien.net/d/msgid/usb-storage/20201017160928.12698-1-trix%40redhat.com.
